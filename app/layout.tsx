...
const RootLayout = () => (
  <html>
      ...
      <div className="container navbar-container">
        <div className="navbar-holder">
          <div className="navbar-container">
            <a
              href="https://ovo-pulse.webflow.io/"
              aria-current="page"
              ...
              <div className="nav-wrapper">
                <div className="nav-container">
                  <div className="nav-menu-link-holder">
                    ...
                    >
                      <a
                        href="https://ovo-pulse.webflow.io/#Work"
                    ...
                    >
                      <a
                        href="https://ovo-pulse.webflow.io/#About"
                        className="nav-link-big w-nav-link w--current"
                      >
                        About
                      </a>
                    </div>
                ...
                >
                  ...
                  <div className="size-holder">
                    <div className="block" />
                    <div className="block-line vertical" />
                    <div className="block" />
                  </div>
                </div>
              </div>
        ...
        <div className="container">
          <div className="hero-text-holder">
            ...
            <div className="hero-text-wrapper">
              <div className="hero-about-text-holder">
                <div className="perspective">
                  <div
                    style={{
                      transform:
                ...
                <div className="hero-about-text-container">
                  <div className="hero-line-holder">
                    <div className="block" />
                    <div
    ...
    <div className="infinite-text-holder">
      <div
        className="infnite-text-wrapper"
        style={{
          opacity: 1,
          transform:
    ...
    <div
      id="About"
      data-w-id="010d7508-cdc8-5eee-6297-c60e998622b0"
    ...
    <div id="Work" className="infinite-text-holder">
      <div
        className="infnite-text-wrapper"
        style={{
          opacity: 1,
    ...
    <div className="section">
      <div className="project-grid-wrapper w-dyn-list">
            ...
            >
              ...
              >
                <div className="content">
                  <div className="project-thumbnail-holder">
                    <img
                      alt=""
                      loading="lazy"
              ...
              <div className="view-project" style={{ opacity: 0 }}>
                <div
                  style={{
                    transform:
                      "translate3d(-62.031%, 0px, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg, 0deg)",
                ...
                >
                  view full project &nbsp;view full project &nbsp; view full
                  project &nbsp;view full project
                </div>
                <div
                  style={{
                    transform:
    ...
    <div className="section footer-section">
      ...
      <div className="container">
        ...
        <div className="footer">
          ...
          <div className="content-inside">
            <div className="footer-up-button-holder">
              <a
                href="https://ovo-pulse.webflow.io/#"
                className="footer-up-button w-inline-block"
              >
                <aside className="up-button-arrow-holder">
                  <img
                    src="./Paiva'S Granite & Marble - Rapair & Installation_files/654bb100f826a821eb3eeccd_Arrow Top Image.svg"
                    loading="lazy"
                    alt=""
